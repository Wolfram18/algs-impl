...
4. Сливаем отсортированные части обратно:  
  a. [5] и [3] -> сравниваем 5 и 3, выбираем 3:  
     [3, 5]  
  b. [8] и [1, 4] -> разделяем [1, 4] на [1] и [4] (они уже отсортированы):  
     [8] | [1] | [4]  
  c. Сливаем [8] и [1]:  
     [1, 8]  
  d. Сливаем [1, 8] и [4]:  
...
5. Теперь сливаем [3, 5] и [1, 4, 8]:  
  a. Сравниваем 3 и 1, выбираем 1:  
     [1, 3, 5] | [4, 8]  
  b. Сравниваем 3 и 4, выбираем 3:  
     [1, 3, 5] | [4, 8]  
  c. Сравниваем 5 и 4, выбираем 4:  
     [1, 3, 4, 5] | [8]  
  d. Добавляем последний элемент 8:  
     [1, 3, 4, 5, 8]  
