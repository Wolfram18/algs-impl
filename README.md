...
[Bubble Sort (Сортировка пузырьком)](#bubble-sort): Один из простейших алгоритмов сортировки.
[Selection Sort (Сортировка выбором)](#selection-sort): Из неотсортированной части массива извлекаем элементы и перенаправляем их в отсортированную область.
[Insertion Sort (Сортировка вставками)](#insertion-sort): Разновидность сортировки выбором.
[Merge Sort (Сортировка слиянием)](#merge-sort): Сортирует такие структуры данных, где доступ к элементам осуществляется последовательно.
[Quick Sort (Быстрая сортировка)](#quick-sort): Один из самых эффективных методов сортировки.
[Heap Sort (Пирамидальная сортировка)](#heap-sort): Метод сортировки сравнением, основанный на такой структуре данных как двоичная куча.
[Shell Sort (Сортировка Шелла)](#shell-sort): Усовершенствованный вариант сортировки вставками.
