...
[Bubble Sort (Сортировка пузырьком)](#bubble-sort): Изучите классический алгоритм, простой в понимании и реализации.  
Selection Sort (Сортировка выбором): Освойте методику выбора и расстановки элементов в последовательности.
Insertion Sort (Сортировка вставками): Освойте тонкости и хитрости одного из самых интуитивных методов сортировки.
Merge Sort (Сортировка слиянием): Разберитесь в принципах работы одного из самых быстрых алгоритмов.
Quick Sort (Быстрая сортировка): Изучите и примените один из самых эффективных методов сортировки.
Heap Sort (Пирамидальная сортировка): Познакомьтесь с особенностями работы с пирамидами и их применением в сортировке.
Shell Sort (Сортировка Шелла): Углубитесь в изучение усовершенствованного варианта сортировки вставками.
