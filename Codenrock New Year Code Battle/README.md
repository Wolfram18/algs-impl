...
**Пример выходных данных:** 1,3,6,8  
...
res = list(filter(lambda x : x.isdigit(),line.replace(","," ").split()))
sticks = []
for i in range(len(res) - 1):
sticks.append(int(res[i]))
